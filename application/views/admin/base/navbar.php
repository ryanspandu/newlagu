<nav class="navbar navbar-expand-lg navbar-light bg-light navbar-main border">
    <div class="container">   
        <div class="d-flex flex-row justify-content-between w-100 align-items-center">
            ...
            <form class="bg-white d-flex flex-row w-50">
            ...
            <div class="d-flex flex-row align-items-center pointer profile-nav-btn">
                Ryan
